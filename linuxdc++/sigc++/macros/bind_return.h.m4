...
ADAPTOR_BIND_RETURN_SLOT(ARGS(P,6))
ADAPTOR_BIND_RETURN_SLOT(ARGS(P,7))
ADAPTOR_BIND_RETURN_SLOT(ARGS(P,8))
ADAPTOR_BIND_RETURN_SLOT(ARGS(P,9))
ADAPTOR_BIND_RETURN_SLOT(ARGS(P,10))
ADAPTOR_BIND_RETURN_SLOT(ARGS(P,11))
