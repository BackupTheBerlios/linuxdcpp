...
ADAPTOR_RETYPE_SLOT(ARGS(P,7),ARGS(C,6))
ADAPTOR_RETYPE_SLOT(ARGS(P,8),ARGS(C,6))
ADAPTOR_RETYPE_SLOT(ARGS(P,9),ARGS(C,6))
ADAPTOR_RETYPE_SLOT(ARGS(P,10),ARGS(C,6))
ADAPTOR_RETYPE_SLOT(ARGS(P,11),ARGS(C,6))
...
ADAPTOR_RETYPE_SLOT(ARGS(P,7),ARGS(C,6),void)
ADAPTOR_RETYPE_SLOT(ARGS(P,8),ARGS(C,6),void)
ADAPTOR_RETYPE_SLOT(ARGS(P,9),ARGS(C,6),void)
ADAPTOR_RETYPE_SLOT(ARGS(P,10),ARGS(C,6),void)
ADAPTOR_RETYPE_SLOT(ARGS(P,11),ARGS(C,6),void)
#endif
