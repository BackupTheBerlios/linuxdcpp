...
ADAPTOR_BIND_SLOT(ARGS(P,5),ARGS(C,1),ARGS(A,1))
ADAPTOR_BIND_SLOT(ARGS(P,6),ARGS(C,1),ARGS(A,1))
ADAPTOR_BIND_SLOT(ARGS(P,7),ARGS(C,1),ARGS(A,1))
ADAPTOR_BIND_SLOT(ARGS(P,8),ARGS(C,1),ARGS(A,1))
ADAPTOR_BIND_SLOT(ARGS(P,9),ARGS(C,1),ARGS(A,1))
...
ADAPTOR_BIND_SLOT(ARGS(P,4),ARGS(C,2),ARGS(A,2))
ADAPTOR_BIND_SLOT(ARGS(P,5),ARGS(C,2),ARGS(A,2))
ADAPTOR_BIND_SLOT(ARGS(P,6),ARGS(C,2),ARGS(A,2))
ADAPTOR_BIND_SLOT(ARGS(P,7),ARGS(C,2),ARGS(A,2))
ADAPTOR_BIND_SLOT(ARGS(P,8),ARGS(C,2),ARGS(A,2))
ADAPTOR_BIND_SLOT(ARGS(P,9),ARGS(C,2),ARGS(A,2))
