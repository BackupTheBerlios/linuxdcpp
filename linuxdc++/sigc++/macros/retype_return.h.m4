...
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,7))
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,8))
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,9))
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,10))
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,11))
...
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,7),void)
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,8),void)
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,9),void)
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,10),void)
ADAPTOR_RETYPE_RETURN_SLOT(ARGS(P,11),void)
#endif
