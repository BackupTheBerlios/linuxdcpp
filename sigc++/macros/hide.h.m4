...
ADAPTOR_HIDE(ARGS(P,4),ARGS(H,2))
ADAPTOR_HIDE(ARGS(P,5),ARGS(H,2))
ADAPTOR_HIDE(ARGS(P,5),ARGS(H,1))
ADAPTOR_HIDE(ARGS(P,6),ARGS(H,2))
ADAPTOR_HIDE(ARGS(P,6),ARGS(H,1))
ADAPTOR_HIDE(ARGS(P,7),ARGS(H,2))
ADAPTOR_HIDE(ARGS(P,7),ARGS(H,1))
ADAPTOR_HIDE(ARGS(P,8),ARGS(H,2))
ADAPTOR_HIDE(ARGS(P,8),ARGS(H,1))
ADAPTOR_HIDE(ARGS(P,9),ARGS(H,2))
ADAPTOR_HIDE(ARGS(P,9),ARGS(H,1))
