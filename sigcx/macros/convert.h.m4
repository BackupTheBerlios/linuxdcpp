...
__SLOT__(R,$1)
  ...
  { 
    return new AdaptorConvertSlotNode((SigC::FuncPtr)(&__CRT_SLOT__(R,$1,T)::proxy),
                                    slot_,
...
ADAPTOR_CONVERT_SLOT(ARGS(P,6))
ADAPTOR_CONVERT_SLOT(ARGS(P,7))
ADAPTOR_CONVERT_SLOT(ARGS(P,8))
ADAPTOR_CONVERT_SLOT(ARGS(P,9))
ADAPTOR_CONVERT_SLOT(ARGS(P,10))
ADAPTOR_CONVERT_SLOT(ARGS(P,11))
